                    ...
                    <div class="dropdown-menu">
                        <div class="menu-header-content bg-primary text-right">
                            <div class="d-flex">
                                ...
                                <span
                                    class="badge badge-pill badge-warning mr-auto my-auto float-left"><a href="{{route('admin.notifications.readAll')}}">Mark All Read</a></span>
                            </div>
                            <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">You
                                have
                                <span
                                    id="notification-count">{{\Illuminate\Support\Facades\Auth::guard('admin')->user()->unreadNotifications()->count()}}</span>
                                unread
                                Notifications</p>
                        </div>
                        <div class="main-notification-list Notification-scroll">
                            @foreach(Auth::user()->unreadNotifications as $notification)
                                <a href="/{{$notification->data['url']}}?notification_id='{{$notification->id}}'"
                                   class="d-flex p-3 border-bottom" href="#">
                                    ...
                                    <div class="mr-3">
                                        ...
                                        <div dir="ltr"
                                             class="notification-subtext">{{ Carbon\Carbon::parse($notification->created_at)->locale('en')->diffForHumans() }}</div>
                                    </div>
                                    <div class="mr-auto">
