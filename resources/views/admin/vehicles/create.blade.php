            ...
            <div class="row">
                            ...
                            <div id="allMake">
                                <div class="row">
                                    <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-4 text-center mb-2 carMake"
                                         data-id="1">
                                        <img src="https://www.autoanddrive.com/images/logos/alfa-romeo.png" width="50"
                                             height="50"/>
                                        <div>Alfa Romeo</div>
                                    </div>
                                    <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-4 text-center mb-2 carMake"
                                         data-id="2">
                                        <img src="https://www.autoanddrive.com/images/logos/audi.png" width="55"
                                             height="28"/>
                                        <div>Audi</div>
                                    </div>
                                    <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-4 text-center mb-2 carMake"
                                         data-id="3">
                                        <img src="https://www.autoanddrive.com/images/logos/bmw.png" width="50"
                                             height="50"/>
                                        <div>BMW</div>
                                    </div>
                                    <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-4 text-center mb-2 carMake"
                                         data-id="4">
                                        <img src="https://www.autoanddrive.com/images/logos/chevrolet.png" width="60"
                                             height="55"/>
                                        <div>Chevrolet</div>
                                    </div>
                                    <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-4 text-center mb-2 carMake"
                                         data-id="5">
                                        <img src="https://www.autoanddrive.com/images/logos/citroen.png" width="60"
                                             height="60"/>
                                        <div>Citroen</div>
                                    </div>
                                    <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-4 text-center mb-2 carMake"
                                         data-id="6">
                                        <img src="https://www.autoanddrive.com/images/logos/dacia.png" width="50"
                                             height="45"/>
                                        <div>Dacia</div>
                                    </div>
                                    <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-4 text-center mb-2 carMake"
                                         data-id="7">
                                        <img src="https://www.autoanddrive.com/images/logos/fiat.png" width="47"
                                             height="47"/>
                                        <div>Fiat</div>
                                    </div>
                                    <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-4 text-center mb-2 carMake"
                                         data-id="8">
                                        <img src="https://www.autoanddrive.com/images/logos/ford.png" width="45"
                                             height="35"/>
                                        <div>Ford</div>
                                    </div>
                                    <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-4 text-center mb-2 carMake"
                                         data-id="9">
                                        <img src="https://www.autoanddrive.com/images/logos/honda.png" width="39"
                                             height="40"/>
                                        <div>Honda</div>
                                    </div>
                                    <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-4 text-center mb-2 carMake"
                                         data-id="10">
                                        <img src="https://www.autoanddrive.com/images/logos/hummer.png" width="70"
                                             height="15"/>
                                        <div>Hummer</div>
                                    </div>
                                    <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-4 text-center mb-2 carMake"
                                         data-id="11">
                                        <img src="https://www.autoanddrive.com/images/logos/hyundai.png" width="50"
                                             height="37"/>
                                        <div>Hyundai</div>
                                    </div>
                                    <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-4 text-center mb-2 carMake"
                                         data-id="12">
                                        <img src="https://www.autoanddrive.com/images/logos/infiniti.png" width="40"
                                             height="40"/>
                                        <div>Infiniti</div>
                                    </div>
                                    <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-4 text-center mb-2 carMake"
                                         data-id="13">
                                        <img src="https://www.autoanddrive.com/images/logos/isuzu.png" width="40"
                                             height="40"/>
                                        <div>Isuzu</div>
                                    </div>
                                    <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-4 text-center mb-2 carMake"
                                         data-id="14">
                                        <img src="https://www.autoanddrive.com/images/logos/jaguar.png" width="55"
                                             height="40"/>
                                        <div>Jaguar</div>
                                    </div>
                                    <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-4 text-center mb-2 carMake"
                                         data-id="15">
                                        <img src="https://www.autoanddrive.com/images/logos/jeep.png" width="45"
                                             height="28"/>
                                        <div>Jeep</div>
                                    </div>
                                    <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-4 text-center mb-2 carMake"
                                         data-id="16">
                                        <img src="https://www.autoanddrive.com/images/logos/kia.png" width="45"
                                             height="35"/>
                                        <div>Kia</div>
                                    </div>
                                    <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-4 text-center mb-2 carMake"
                                         data-id="17">
                                        <img src="https://www.autoanddrive.com/images/logos/land-rover.png" width="52"
                                             height="40"/>
                                        <div>Land Rover</div>
                                    </div>
                                    <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-4 text-center mb-2 carMake"
                                         data-id="18">
                                        <img src="https://www.autoanddrive.com/images/logos/lexus.png" width="60"
                                             height="50"/>
                                        <div>Lexus</div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
                    <div class="card mb-1">
                        ...
                        <div class="card-body">
                            <input name="price_type" hidden type="text" value="" id="priceHideShow">
