<x-front title="{{$vehicle->vehicle_name}}">
    <x-slot:breadcrumbs>
        <div class="container">
            ...
            <span class="sep">»</span>
            <span typeof="v:Breadcrumb"><span property="v:title" class="current">تعديل المركبة</span></span>
        </div>
    </x-slot:breadcrumbs>
    <div class="container mt-1 mb-5">
        ...
        @endif
        <form method="POST" action="{{route('front.vehicles.update',$vehicle->id)}}">
            @method('PUT')
            @csrf
            <div class="row">
                <div class="col-12">
                                ...
                                <div class="row">
                                    @foreach($mades as $made)
                                        <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-4 text-center mb-2 carMake"
                                             data-id="{{$made->id}}">
                                            <img src="{{asset('storage/'.$made->image)}}" width="45" height="45"/>
                                            <div>{{$made->name}}</div>
                                        </div>
                                    @endforeach
                                </div>
                            </div>
                            <div class="mt-1 mb-1 card-body" id="chosenCarOnAdd">
                                <hr/>
                                <input hidden type="text" value="{{$vehicle->made_id}}" name="made_id" id="makes_type"/>
                                <input hidden type="text" value="{{$vehicle->mould_id}}" name="mould_id"
                                       id="made_type"/>
                                <div class="row">
                                    <div class="col-2 text-center" id="MakeImg">
                                        <img src="{{asset('storage/'.$vehicle->made->image)}}" width="120"
                                             height="100"/>
                                    </div>
                                    <div class="col-2 text-center" id="MakeName">{{$vehicle->made->name}}</div>
                                    <div class="col-2 text-center" id="ModelName">{{$vehicle->mould->name}}</div>
                                    <div class="col-2 text-center">
                                        <div class="btn btn-warning" id="deleteUserChoice">
                ...
                <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <input type="hidden" value="{{$vehicle->fuel}}" name="fuel" id="fuelType">
                ...
                <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <input id="gearType" value="{{$vehicle->gear}}" name="gear" type="text" hidden/>
                ...
                <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <input name="payment_method" value="{{$vehicle->payment_method}}" hidden type="text"
                                   id="payment_method">
                ...
                <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <input name="num_of_seats" value="{{$vehicle->num_of_seats}}" hidden type="text"
                                   id="numSeats">
                ...
                <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <input name="vehicle_status" value="{{$vehicle->vehicle_status}}" hidden type="text"
                                   id="vehicleStatus">
                ...
                <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <input type="text" value="{{$vehicle->drivetrain_system}}" hidden name="drivetrain_system"
                                   id="drivetrain_system"/>
                ...
                <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
                    <div class="card mb-1">
                        ...
                        <div class="card-body">
                            <input type="number" pattern="\d*" value="{{$vehicle->power}}" class="form-control mb-1"
                ...
                <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
                    <div class="card mb-1">
                        ...
                        <div class="card-body mb-4">
                            <input type="number" pattern="\d*" value="{{$vehicle->mileage}}" class="form-control mb-1"
                            ...
                            <select class="form-control" name="year_of_product">
                                ...
                                @php
                                    for ($i = date('Y'); $i >= 1976; $i--) {
                                             $isSelected = ($vehicle->year_of_product == $i) ? 'selected' : '';
                ...
                <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
                    <div class="card mb-1">
                        ...
                        <div class="card-body">
                            <input type="number" pattern="\d*" value="{{$vehicle->price}}" step="1"
                    ...
                    <div class="card mb-1">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="card-body mb-4">
                                    <div class="d-grid gap-2">
                                        <input hidden type="text" value="{{$vehicle->body_color}}" name="body_color"
                                               id="carExternalColorBx">
                                        <div id="carExternalColor" style="background-color: {{$vehicle->body_color}}"
                                             class="btn btn-light"
                            ...
                            <div class="col-6">
                                <div class="card-body mb-4">
                                    <div class="d-grid gap-2">
                                        <input hidden type="text" value="{{$vehicle->interior_color}}"
                                               name="interior_color"
                                               id="carFurnitureColorBx">
                                        <div id="carInternalColor" style="background-color:{{$vehicle->interior_color}}"
                                             class="btn btn-light"
                    ...
                    <div class="card mb-1">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <input type="hidden" value="{{$vehicle->oimg}}" name="oimg" class="oimg"/>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card mb-1">
                        <div class="card-header text-white bg-blue">التحكم بالصور</div>
                        <div class="card-body">
                            <div class="row">
                                @foreach(explode(',',$vehicle->oimg) as $image)
                                    <div class="col-2">
                                        <div class="edit-img">
                                            <div class="deleteImg" id="{{$vehicle->id}}" data-image="{{$image}}">
                                                <i class="fas fa-trash-alt"></i>
                                            </div>
                                            <img src="{{asset('storage/'.$image)}}" style="max-height: 150px"/>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="card mb-1">
                                ...
                                <div class="card-body">
                                    <input hidden type="text" value="{{$vehicle->num_of_keys}}" name="num_of_keys"
                                           id="num_of_keys">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="card mb-1">
                                ...
                                <div class="card-body">
                                    <input hidden type="text" value="{{$vehicle->extra->ext_int_furniture}}"
                                           name="ext_int_furniture" id="ext_int_furniture">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="card mb-1">
                                ...
                                <div class="card-body">
                                    <input type="text" value="{{$vehicle->extra->ext_int_sunroof}}" hidden
                                           name="ext_int_sunroof" id="ext_int_sunroof">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="card mb-1">
                                <div class="card-header text-white bg-blue">الزجاج
                                    <div class="float-start">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="ext_int_glass_check">إختيار
                                                الجميع</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <input hidden type="text" value="{{$vehicle->extra->ext_int_glass}}"
                                           name="ext_int_glass" id="ext_int_glass">
                                ...
                                <div class="card-header text-white bg-blue">المقاعد
                                    <div class="float-start">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="ext_int_seats_check">إختيار
                                                الجميع</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <input hidden type="text" value="{{$vehicle->extra->ext_int_seats}}"
                                           name="ext_int_seats" id="ext_int_seats">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="card mb-1">
                                ...
                                <div class="card-body">
                                    <input hidden type="text" value="{{$vehicle->extra->ext_int_screens}}"
                                           name="ext_int_screens" id="ext_int_screens">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="card mb-1">
                                ...
                                <div class="card-body">
                                    <input hidden type="text" value="{{$vehicle->extra->ext_int_other}}"
                                           name="ext_int_other" id="ext_int_other">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="card mb-1">
                                ...
                                <div class="card-body">
                                    <input type="hidden" value="{{$vehicle->extra->ext_int_steering}}"
                                           name="ext_int_steering" id="ext_int_steering">
                    ...
                    <div class="row">
                                ...
                                <div class="card-header text-white bg-blue">الإضاءة
                                    <div class="float-start">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="ext_ext_light_check">إختيار
                                                الجميع</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <input hidden type="text" value="{{$vehicle->extra->ext_ext_light}}"
                                           name="ext_ext_light" id="ext_ext_light">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="card mb-1">
                                ...
                                <div class="card-body">
                                    <input hidden type="text" value="{{$vehicle->extra->ext_ext_mirrors}}"
                                           name="ext_ext_mirrors" id="ext_ext_mirrors">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="card mb-1">
                                ...
                                <div class="card-body">
                                    <input hidden type="text" value="{{$vehicle->extra->ext_ext_rims}}"
                                           name="ext_ext_rims"
                                           id="ext_ext_rims">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
                            <div class="card mb-1">
                                ...
                                <div class="card-body">
                                    <input hidden type="text" value="{{$vehicle->extra->ext_ext_sensors}}"
                                           name="ext_ext_sensors" id="ext_ext_sensors">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="card mb-1">
                                ...
                                <div class="card-body">
                                    <input hidden type="text" value="{{$vehicle->extra->ext_ext_cameras}}"
                                           name="ext_ext_cameras" id="ext_ext_cameras">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="card mb-1">
                                ...
                                <div class="card-body">
                                    <input hidden type="text" value="{{$vehicle->extra->ext_ext_other}}"
                                           name="ext_ext_other" id="ext_ext_other">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                            <div class="card mb-1">
                                ...
                                <div class="card-body">
                                    <input hidden type="text" value="{{$vehicle->extra->ext_gen_other}}"
                                           name="ext_gen_other" id="ext_gen_other">
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button id="save_model_modal" type="button" class="btn btn-primary"
    ...
    @push('js')
        <script>
            $(function () {
                    ...
                    let imageCount = {{ count(explode(',',$vehicle->oimg)) }};
                    if(imageCount>3){
                        $('#multiple_files').hide();
                    }
                    ...
                    function setData(className) {
                        $("." + className).click(function () {
                            var checkbox = $('.' + className).parent().prev().find('.form-check-input');
                            if (!checkbox.length) {
                                // Remove the "btn-secondary" class from all elements with the same class name
                                $("." + className).removeClass("btn-secondary");

                                // Add the "btn-secondary" class to the clicked element
                                $(this).addClass("btn-secondary");

                                // Set the value of the input field to the data-id attribute of the clicked element
                                $("#" + className).val($(this).attr("data-id"));
                            }
                        });

                        // Get the stored value from the input field
                        var storedValue = $("#" + className).val();

                        // Set the "btn-secondary" class on elements corresponding to the stored data IDs
                        if (storedValue) {
                            var dataIds = storedValue.split(",");
                            for (var i = 0; i < dataIds.length; i++) {
                                $("div[data-id='" + dataIds[i] + "']").addClass("btn-secondary");
                            }
                        }

                        // Add click event listener to the edited element
                        $("div[data-id='" + storedValue + "']").click(function () {
                            // Remove the "btn-secondary" class from all elements with the same class name
                            $("." + className).removeClass("btn-secondary");
                            ...
                            // Remove the click event listener to prevent conflicts
                            $(this).off("click");
                        });
                    }
                    ...
                    setData("ext_ext_sensors");
                    setData("ext_ext_cameras");
                    setData("ext_int_furniture");
                    setData("ext_int_sunroof");
                    setData("ext_int_glass");
                    setData("ext_int_seats");
                    setData("ext_int_screens");
                    setData("ext_int_other");
                    setData("ext_int_steering");
                    setData("ext_ext_light");
                    setData("ext_ext_mirrors");
                    setData("ext_ext_other");
                    setData("ext_gen_other");
                        ...
                        if (files.length > 20) {
                            ...
                            if (error_images === '') {
                                ...
                                $.ajax({
                                    ...
                                    url: "{{route('upload',['folder' => 'vehicles', 'vehicle_id' => $vehicle->id])}}",
                                    method: "POST",
                                    data: form_data,
                                    contentType: false,
                                    cache: false,
            ...
            $(".deleteImg").click(function () {
                let thisImg = $(this);
                let val = thisImg.attr("id");
                let imgValue = thisImg.attr("data-image");
