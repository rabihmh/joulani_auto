...
(function(a) {
    ...
    a.fn.SumoSelect = function(b) { // Extra check for IE compatibility
        var c = function(a, b) {
            var c;
            "function" == typeof Event ? c = new Event(b) : (c = document.createEvent("Event"), c.initEvent(b, !0, !0)), a.dispatchEvent(c)
                    ...
                    this.sumo = {
                        ...
                        SelAll: function SelAll() {
                            ...
                            if (b.is_multi) {
                                ...
                                b.selAll.find("label")[0].innerText = c[2], b.optDiv.addClass("selall"), b.selAll.on("click", function() {
                                    b.selAll.toggleClass("selected"), b.toggSelAll(b.selAll.hasClass("selected"), 1)
                        ...
                        Search: function Search() {
                            ...
                            c.ftxt = a("<input type=\"text\" class=\"search-txt\" value=\"\" autocomplete=\"off\">").on("click", function(a) {
                                a.stopPropagation()
                            }), c.ftxt.placeholder = f.searchText, d.append(c.ftxt), c.optDiv.children("ul").after(e), c.ftxt.on("keyup.sumo", function() {
                        ...
                        selAllState: function selAllState() {
                            ...
                            if (f.selectAll && b.is_multi) {
                                var c = 0,
                                    d = 0;
                                b.optDiv.find("li.opt").not(".hidden .disabled").each(function(b, f) {
                                    a(f).hasClass("selected") && c++, d++
                                }), c == d ? b.selAll.removeClass("partial").addClass("selected") : 0 === c ? b.selAll.removeClass("selected partial") : b.selAll.addClass("partial")
                            }
                        },
                        ...
                        setText: function setText() {
                            ...
                            if (a.placeholder = "", a.is_multi) {
                                ...
                                a.placeholder = f.csvDispCount && d.length > f.csvDispCount ? d.length === a.E.find("option").length && f.captionFormatAllSelected ? f.captionFormatAllSelected.replace(/\{0\}/g, d.length) : f.captionFormat.replace(/\{0\}/g, d.length) : d.toArray().map(function(a) {
                                    return a.innerText
                                }).join(", ")
                        ...
                        toggSelAll: function toggSelAll(b, c) {
                            ...
                            d.E.off(), d.is_multi ? b ? d.E.find("option:not(:checked):not(:disabled):not(:hidden)").toArray().forEach(function(b) {
                                a(b).data("li").hasClass("hidden") || (b.selected = !0, a(b).data("li").toggleClass("selected", !0))
                            }) : d.E.find("option:checked:not(:disabled):not(:hidden)").toArray().forEach(function(b) {
                        ...
                        unload: function unload() {
                            var a = this;
                            return a.select.before(a.E), a.E.show(), a.E[0].classList.remove("SumoUnder"), f.outputAsCSV && a.is_multi && a.select.find("input.HEMANT123").length && a.E.attr("name", a.select.find("input.HEMANT123").attr("name")), a.select.remove(), delete e.sumo, a.E.trigger("sumo:unloaded", a), e
                        ...
                        removeAll: function removeAll() {
                            for (var a = this, b = a.E.find("option"), c = b.length - 1; 0 <= c; c--) !0 !== b[c].selected && a.remove(c)
                        },
